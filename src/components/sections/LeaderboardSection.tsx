    ...
    <section className="section" id="leaderboard">
      <div className="container">
        ...
        <div className="leaderboard-grid">
          ...
          <div className="leaderboard-ad-rail">
            <AdSlot
              label={isGerman ? "Werbung" : "Sponsored"}
              title={isGerman ? "Leaderboard Placement" : "Leaderboard placement"}
              description={
                isGerman
                  ? "Diese Flaeche sitzt neben dem globalen Ranking und bleibt klar von den eigentlichen Scoring-Zeilen getrennt."
                  : "This surface sits next to the global ranking and remains clearly separated from the scoring rows themselves."
              }
